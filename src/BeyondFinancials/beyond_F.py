...
def main_beyond_FR():
    ...
    st.title("Biyond Financials Report Generator")
    ...
    with bfr:
        ...
        if FPNL_REPORT != "" and BS_REPORT != "" and CF_REPORT != "":
            ...
            user_prompt =f""" create a professional report using the following data:"""
            ...
            if data:
                user_prompt = data[0]['executive-summary']
            else:
                pass
               # st.session_state.user_prompt = default_prompt   
            #st.session_state.user_prompt = default_prompt
        ...
        if st.button("Generate Report", key="generate_report_button"):     
            ...
            try:
                ...
                messages = [
                    {"role": "system", "content": "You are a financial report expert."},
                    {"role": "user", "content": user_prompt + " Using Profit & Loss report, balance sheet report and cahsh flow reports. Here is all reports porvided :: "
                    " Profit & Loss report:-> {PNL_REPORT}, --------- Balance Sheet report:-> {BS_REPORT}, --------- Cash Flow report:-> {CF_REPORT}"}
                ]
